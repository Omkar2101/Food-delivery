    ...
    return (
        <>
            <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
                ...
                {/* Menu  */}
                <div className={`fixed bg-black/80 w-full h-screen top-0 left-0 z-10 transition-opacity duration-300 ${nav ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
                    {/* Side drawer menu */}
                    <div className={`bg-white w-[300px] md:w-[400px] lg:w-[500px] h-screen fixed left-0 transition-transform duration-300 ${nav ? 'translate-x-0' : '-translate-x-full'}`}>
                        <div className='p-4'>
                            ...
                            <div className='my-8'>
                                <nav>
                                    <ul className='cursor-pointer flex text-lg items-center p-2 gap-2 border-b-2'>
                                        <BsTruck />
                                        <li>Shipping</li>
                                    </ul>
                                    <ul className='cursor-pointer flex text-lg items-center p-2 gap-2 border-b-2'>
